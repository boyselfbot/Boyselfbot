...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EqgExFc1T3b8nxQ2RfNe.64dVT6JRfdiYS8giPAzpxG.PVI0e+G21ykzzLe5GOFEl41G+58syyCIhbw0A+GccWU=") 
cl.loginResult()
...
ki3 = LINETCR.LINE()
ki3.login(token="Eq01CCtc4b4XtsWAgGo1.BQgKwgRdMHxucuP8HM0umq.KJsS4gYOiPply6PjRQBG+dYdGZH9MXR3Pp8oD0et/gs=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EqHJtRo2qUF5lTHQVlzc.a+i4v6oU900hV1uJEn0zJa.nY5KllbtTCAHMaw2/AAB1D0dTKDtd4H4DZGZ694pbJg=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EqFufnKLpv6WWUeM2703.Wgzt4Z3CF4e/+jVzQNkBSW.cPmpDsqq9110VJ1yNz8Gs31kydnpGbJZiM5S6rZ9EsI=")
ki5.loginResult()

k1 = LINETCR.LINE()
k1.login(token="EqhLnZWJCbpqJ4UV6Wo2.aWwFsXsZ7hARJiz2CcXpSG.T995D2AiUIbnCHRBA++sG+14l87zKkfrSrxTCEELBqo=")
k1.loginResult()

k2 = LINETCR.LINE()
k2.login(token="Eq3tnaglCrPpVsYYCwo3.SaPoxHRUS91KG4ZRBhlqCW.kpexXCz+Wvymb7Gr1bUhAh+sfk/sld0b8z23qm/k0oM=")
k2.loginResult()

k3 = LINETCR.LINE()
k3.login(token="Eql7QIB7Or1d2q2BzbU5.VAanTraByVlzwDzeFHrvjq.L/+6cVBfVcGA0TlmAnpsOWzxZr3k8D+rb0EHQPcfpi4=")
k3.loginResult()

k4 = LINETCR.LINE()
k4.login(token="EqXoWymQBNHxETdxNIZ7.GMDtix1gwlaKwlMfbYzIXW.ncdnClAkRACwZIWnPDDF7YqH8Kz9EKM60lIfVwe4v8A=")
k4.loginResult()

k5 = LINETCR.LINE()
k5.login(token="EqAltDhYOyEJZGnoPOec.P4bZ/fBf0hIumuuVXCVtJa.cBYM5iYBCHKghAOgv1F5sS+u7pnvp7j5BqwxvmCRJcQ=")
k5.loginResult()
...
DEF=[ki,ki2,ki3,ki4,ki5,k1,k2,k3,k4,k5]
...
autoleaveroom = []
targets = []
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,k1mid,k2mid,k3mid,k4mid,k5mid,"ueb80efb7a8eb143232b3c188a5a64f5e"]
...
mybackup = k1.getProfile()
mybackup.displayName = contact.displayName
mybackup.statusMessage = contact.statusMessage
mybackup.pictureStatus = contact.pictureStatus

contact = k2.getProfile()
mybackup = k2.getProfile()
mybackup.displayName = contact.displayName
mybackup.statusMessage = contact.statusMessage
mybackup.pictureStatus = contact.pictureStatus

contact = k3.getProfile()
mybackup = k3.getProfile()
mybackup.displayName = contact.displayName
mybackup.statusMessage = contact.statusMessage
mybackup.pictureStatus = contact.pictureStatus

contact = k4.getProfile()
mybackup = k4.getProfile()
mybackup.displayName = contact.displayName
mybackup.statusMessage = contact.statusMessage
mybackup.pictureStatus = contact.pictureStatus

contact = k5.getProfile()
mybackup = k5.getProfile()
mybackup.displayName = contact.displayName
mybackup.statusMessage = contact.statusMessage
mybackup.pictureStatus = contact.pictureStatus
...
#-------------ขโมย---------------
            ...
            elif msg.text.lower() in ["kill ban"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
...
#---------------คำสั่งใหม่----------
                ...
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ...
                k1.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                k2.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                k3.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                k4.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                k5.sendText(msg.to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ki.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")  
                       ki2.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")  
                       ki3.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ki4.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ki5.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       k1.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       k2.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       k3.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       k4.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       k5.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ki.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       kk.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       kc.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       kd.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ke.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       ki.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       kk.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                       kc.sendText(g.mid,"ŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                   ...
                   for target in targets:
                       try:
                           ...
                           k5.sendText(msg.to,"Limit mak.")
															
	    elif "Imagetxt" in msg.text:
                bahasa_awal = 'th'
                bahasa_tujuan = 'th'
                kata = msg.text.replace("Imagetxt ","")
                url = 'https://translate.google.com/m?sl=%s&tl=%s&ie=UTF-8&prev=_m&q=%s' % (bahasa_awal, bahasa_tujuan, kata.replace(" ", "+"))
                ...
                k1.sendText(msg.to,"Bot 💀6💀 \nŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                k2.sendText(msg.to,"Bot 💀7💀 \nŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                k3.sendText(msg.to,"Bot 💀8💀 \nŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                k4.sendText(msg.to,"Bot 💀9💀 \nŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                k5.sendText(msg.to,"Bot 💀10💀 \nŤỂÄΜ Bot :👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
               ...
               # cl.sendText(msg.to,"Auto Respon OFF")
                ...
                if wait["kickMention"] == True: md+="🔒 เปิดแทคแตะ → ✔\n"
                else: md+="🔒 ปิดแทคแตะ → ❌\n"
...
#----------------------------------------------------------------
            ...
            elif msg.text in ["Reject","1ลบรัน"]:
                gid = ki.getGroupIdsInvited()
                for i in gid:
                    ki.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    ki.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","2ลบรัน"]:
                gid = ki2.getGroupIdsInvited()
                for i in gid:
                    ki2.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki2.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    ki2.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","3ลบรัน"]:
                gid = ki3.getGroupIdsInvited()
                for i in gid:
                    ki3.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki3.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    ki3.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","4ลบรัน"]:
                gid = ki4.getGroupIdsInvited()
                for i in gid:
                    ki4.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki4.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    ki4.sendText(msg.to,"key is wrong")
                    
                    
            elif msg.text in ["Reject","5ลบรัน"]:
                gid = ki5.getGroupIdsInvited()
                for i in gid:
                    ki5.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki5.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    ki5.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","6ลบรัน"]:
                gid = k1.getGroupIdsInvited()
                for i in gid:
                    k1.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    k1.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    k1.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","7ลบรัน"]:
                gid = k2.getGroupIdsInvited()
                for i in gid:
                    k2.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    k2.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    k2.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","8ลบรัน"]:
                gid = k3.getGroupIdsInvited()
                for i in gid:
                    k3.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    k3.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    k3.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","9ลบรัน"]:
                gid = k4.getGroupIdsInvited()
                for i in gid:
                    k4.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    k4.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    k4.sendText(msg.to,"key is wrong")
                    
            elif msg.text in ["Reject","10ลบรัน"]:
                gid = k5.getGroupIdsInvited()
                for i in gid:
                    k5.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    k5.sendText(msg.to,"ปฏิเสทคำเชิญเข้ากลุ่มทั้งหมดเรียบร้อย")
                else:
                    k5.sendText(msg.to,"key is wrong")
